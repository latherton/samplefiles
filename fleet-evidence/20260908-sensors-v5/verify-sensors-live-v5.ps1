...
$sensorReceiptPath = 'D:\KDDeployment\navy-sensor-http-v5.json'
$sensorHtmlPath = 'D:\KDDeployment\NavyDemo\sensor-review-v5.html'
...
$sensorReport = [ordered]@{schema='fleet.sensor.http-acceptance.v5'; complete=$false; started_at=[DateTimeOffset]::UtcNow.ToString('o');
...
try {
    ...
    $missing = Invoke-SensorHttp '/api/telemetry?asset=A-17&mode=kd&source=missing-sensor-acceptance-v5'
