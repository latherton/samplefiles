#!/usr/bin/env python3
"""Reviewed Linux-root equipment-case update; only the app service changes.
...
def main():
    ...
    report = BASE / ('navy-equipment-cases-' + args.release + '.json')
    ...
    try:
        ...
        save('equipment-case-update-accepted-without-case-mutations-imports-or-source-starts')
